...
function displayBanner(price) {
  ...
  banner.innerHTML = `<div class="grp-shop-logo"><img src="${
    window.APPv2URL
  }/images/GROUPSHOP-logo.svg" class="link-logo"></div> <div class="grp-shop-text">Shop with friends, <br> get <strong>$${parseFloat(
    price,
