...
function displayBanner(price) {
  ...
  banner.innerHTML = `<div class="grp-shop-logo"><img src="https://app.groupshop.co/images/GROUPSHOP-logo.svg" class="link-logo"></div> <div class="grp-shop-text">Shop with friends, <br> get <strong>$${parseFloat(
    price,
